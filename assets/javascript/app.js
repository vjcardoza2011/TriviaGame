$("#start").on("click", function() {
  ...
  var questions = [
    {
      question:
        "What Dallas Cowboy holds the NFL record for most passes to start a career without an interception?",
      answers: ["Tony Romo", "Troy Aikman", "Dak Prescott", "Roger Staubach"],
      correctAnswer: "Dak Prescott"
    },
    {
      question:
        "Who was the first Dallas Cowboy to win the National Football League MVP Award?",
      answers: ["Roger Staubach", "Emmitt Smith", "Randy White", "Bob Lilly"],
      correctAnswer: "Emmitt Smith"
    },
    {
      question:
        "The 2014 season ended on an overturned call of a completed catch by what receiver?",
      answers: [
        "Cole Beasley",
        "Jason Witten",
        "Dez Bryant",
    ...
    {
      question:
        "How many years was Troy Aikman in the NFL before he finished a season with more touchdowns than interceptions?",
      answers: ["2", "1", "3", "4"],
      correctAnswer: "3"
    },
    {
      question:
        "What undrafted free agent replaced Drew Bledsoe as QB during the 2006 season?",
  ...
  var playGame = {
    ...
    result: function() {
      ...
      $("#subwrapper").append(
        "<br><h3> Correct Answers: " + this.correct + "</h3>"
      );
      $("#subwrapper").append(
